...
def get_routine_exercises(routine: str) -> list[str]:
    """Get the exercise names for a routine like 'morning' or 'quick'."""
    if routine not in ROUTINES:
        return []
    return [EXERCISES[key]["name"] for key in ROUTINES[routine]]
