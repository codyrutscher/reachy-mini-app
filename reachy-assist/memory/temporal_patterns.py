...
def analyze(patient_id: str = "default") -> list:
    ...
    if findings:
        logger.info("Detected %d patterns", len(findings))
    return findings
...
def _detect_mood_trends(patient_id) -> list:
    ...
    try:
        ...
        logger.error("Mood trend error: %s", e)
    return findings
...
def _detect_topic_changes(patient_id) -> list:
    ...
    try:
        ...
        logger.error("Topic change error: %s", e)
    return findings
...
def _detect_health_mentions(patient_id) -> list:
    ...
    try:
        ...
        logger.error("Health mention error: %s", e)
    return findings
...
def _detect_engagement_drop(patient_id) -> list:
    ...
    try:
        ...
        logger.error("Engagement error: %s", e)
    return findings
...
def _detect_sleep_changes(patient_id) -> list:
    ...
    try:
        ...
        logger.error("Sleep change error: %s", e)
    return findings
