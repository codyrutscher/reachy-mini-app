...
class TestJokes:
    ...
    def test_tell_joke_no_repeats(self):
        from jokes import tell_joke, _told
        _told.clear()
        jokes = set()
        for _ in range(10):
            jokes.add(tell_joke())
    ...
    def test_joke_setup_punchline(self):
        from jokes import tell_joke_setup_punchline
...
class TestAffirmations:
    ...
    def test_morning_affirmation(self):
        from affirmations import morning_affirmation
...
class TestCompanion:
    ...
    def test_get_conversation_starter(self):
        from companion import get_conversation_starter, _used_topics
        _used_topics.clear()
    ...
    def test_get_topic_starter(self):
        from companion import get_topic_starter
...
class TestDatetimeHelper:
    ...
    def test_get_full_briefing(self):
        from datetime_helper import get_full_briefing
        result = get_full_briefing()
        assert "it's" in result.lower()

    def test_holidays_dict(self):
        from datetime_helper import HOLIDAYS
